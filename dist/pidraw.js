...
var o = (i, t, e) => (ai(i, t, "read from private field"), e ? e.call(i) : t.get(i)), p = (i, t, e) => t.has(i) ? es("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(i) : t.set(i, e), d = (i, t, e, s) => (ai(i, t, "write to private field"), s ? s.call(i, e) : t.set(i, e), e), b = (i, t, e) => (ai(i, t, "access private method"), e);
const mi = {}, ms = [];
function _(i, t) {
  if (Array.isArray(i)) {
    for (const e of i)
...
const _s = /^([+-]?(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?)([a-z%]*)$/i, jn = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i, Fn = /rgb\((\d+),(\d+),(\d+)\)/, Rn = /(#[a-z_][a-z0-9\-_]*)/i, $n = /\)\s*,?\s*/, Bn = /\s/g, is = /^#[a-f0-9]{3}$|^#[a-f0-9]{6}$/i, ss = /^rgb\(/, ns = /^(\s+)?$/, rs = /^[+-]?(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, qn = /\.(jpg|jpeg|png|gif|svg)(\?[^=]+.*)?/i, Mt = /[\s,]+/, Bi = /[MLHVCSQTAZ]/i;
function Vn() {
...
class E {
  ...
  */
  ...
  hsl() {
    const { _a: t, _b: e, _c: s } = this.rgb(), [n, r, h] = [t, e, s].map((L) => L / 255), a = Math.max(n, r, h), c = Math.min(n, r, h), l = (a + c) / 2, u = a === c, f = a - c, m = u ? 0 : l > 0.5 ? f / (2 - a - c) : f / (a + c), x = u ? 0 : a === n ? ((r - h) / f + (r < h ? 6 : 0)) / 6 : a === r ? ((h - n) / f + 2) / 6 : a === h ? ((n - r) / f + 4) / 6 : 0;
    return new E(360 * x, 100 * m, 100 * l, "hsl");
  }
  init(t = 0, e = 0, s = 0, n = 0, r = "rgb") {
    ...
    if (typeof t == "number")
      ...
      if (ss.test(t)) {
        const f = t.replace(Bn, ""), [m, x, v] = Fn.exec(f).slice(1, 4).map((L) => parseInt(L));
        Object.assign(this, { _a: m, _b: x, _c: v, _d: 0, space: "rgb" });
      } else if (is.test(t)) {
        const f = (L) => parseInt(L, 16), [, m, x, v] = jn.exec(ir(t)).map(f);
        Object.assign(this, { _a: m, _b: x, _c: v, _d: 0, space: "rgb" });
  ...
  rgb() {
    ...
    if (rr(this.space)) {
      ...
      if (this.space === "lab" || this.space === "lch") {
        let { l: x, a: v, b: L } = this;
        if (this.space === "lch") {
          const { c: Vt, h: $e } = this, Be = Math.PI / 180;
          v = Vt * Math.cos(Be * $e), L = Vt * Math.sin(Be * $e);
        }
        const A = (x + 16) / 116, $ = v / 500 + A, lt = A - L / 200, ut = 16 / 116, St = 8856e-6, Lt = 7.787;
...
class y {
  ...
  decompose(t = 0, e = 0) {
    const s = this.a, n = this.b, r = this.c, h = this.d, a = this.e, c = this.f, l = s * h - n * r, u = l > 0 ? 1 : -1, f = u * Math.sqrt(s * s + n * n), m = Math.atan2(u * n, u * s), x = 180 / Math.PI * m, v = Math.cos(m), L = Math.sin(m), A = (s * r + n * h) / l, $ = r * f / (A * s - n) || h * f / (A * n + s), lt = a - t + t * v * f + e * (A * v * f - L * $), ut = c - e + t * L * f + e * (A * L * f + v * $);
    return {
  ...
  inverseO() {
    ...
    const c = n / a, l = -e / a, u = -s / a, f = t / a, m = -(c * r + u * h), x = -(l * r + f * h);
    return this.a = c, this.b = l, this.c = u, this.d = f, this.e = m, this.f = x, this;
  }
  lmultiply(t) {
...
function mr(i) {
  return at(this.node.querySelector(i));
}
let gr = 0;
const Ts = {};
function Ns(i) {
...
class $t extends De {
  ...
  get(t) {
    return at(this.node.childNodes[t]);
  }
  getEventHolder() {
    return this.node;
  }
  ...
  parent(t) {
    ...
    if (e = at(e.node.parentNode), !t) return e;
    do
      if (typeof t == "string" ? e.matches(t) : e instanceof t)
        return e;
    while (e = at(e.node.parentNode));
    return e;
  }
...
k($t, { attr: vr, find: pr, findOne: mr });
T($t, "Dom");
class gt extends $t {
  constructor(t, e) {
...
_({
  ...
  Defs: {
    gradient: P(function(i, t) {
      return this.put(new Pe(i)).update(t);
    })
  }
});
T(Pe, "Gradient");
...
class nt extends De {
  ...
  */
  ...
  animate(t, e, s) {
    const n = nt.sanitise(t, e, s), r = new nt(n.duration);
  ...
  */
  ...
  position(t) {
    ...
    if (t == null) {
      const m = function(v) {
        const L = h * Math.floor(v % (2 * (n + s)) / (n + s)), A = L && !a || !L && a, $ = Math.pow(-1, A) * (v % (n + s)) / s + A;
...
_({
  Element: {
    animate(i, t, e) {
      const s = nt.sanitise(i, t, e), n = this.timeline();
      return new nt(s.duration).loop(s).element(this).timeline(n.play()).schedule(s.delay, s.when);
    },
    delay(i, t) {
...
k(nt, {
  ...
  transform(i, t, e) {
    ...
    function f(x) {
      ...
      const { x: v, y: L } = new X(r).transform(
        h._currentTransform(this)
      );
      let A = new y({ ...i, origin: [v, L] }), $ = this._isDeclarative && a ? a : l;
      if (e) {
        A = A.decompose(v, L), $ = $.decompose(v, L);
    ...
    function m(x) {
      (x.origin || "center").toString() !== (i.origin || "center").toString() && (r = gi(x, h)), i = { ...x, origin: r };
    }
...
k(nt, { rx: Gi, ry: Ui, from: Ds, to: Ps });
T(nt, "Runner");
class Wi extends st {
  constructor(t, e = t) {
  ...
  defs() {
    return this.isRoot() ? at(this.node.querySelector("defs")) || this.put(new Vi()) : this.root().defs();
  }
  isRoot() {
  ...
  text(t) {
    if (t === void 0) {
      ...
      for (let n = 0, r = e.length; n < r; ++n) {
        ...
        n !== s && e[n].nodeType !== 3 && at(e[n]).dom.newLined === !0 && (t += `
`), t += e[n].textContent;
      }
      return t;
    }
...
T(Us, "Use");
const Xs = J;
k([Wi, Ki, si, ke, Ve], it("viewbox"));
k([Ce, Re, Fe, ne], it("marker"));
k(mt, it("Text"));
k(ne, it("Path"));
k(Vi, it("Defs"));
k([mt, ri], it("Tspan"));
k([ni, ii, Pe, nt], it("radius"));
k(De, it("EventTarget"));
k($t, it("Dom"));
k(gt, it("Element"));
k(rt, it("Shape"));
...
function Mo(i) {
  return i !== null && typeof i == "object" && i.constructor.name.startsWith("Line");
}
...
class So {
  constructor(t, e, s) {
    ...
    d(this, ce, t), d(this, Oe, e), d(this, et, Object.assign(
      ...
      s
    )), d(this, Wt, s.text ?? e), d(this, Tt, 0), d(this, Nt, 0), d(this, Ae, "display: block; position: fixed; white-space:nowrap"), d(this, B, b(this, Ie, Ni).call(this));
  }
  get config() {
    return o(this, et);
  }
  ...
  setLabel(t) {
    return t !== void 0 && d(this, Wt, t), b(this, Ie, Ni).call(this), this;
  }
  move(t, e) {
...
class ts {
  ...
  getValueAtY(t) {
    const e = this.slope;
    return Lo(e) ? this._A.x : (t - this.ordinate) / this.slope;
  }
  intersection(t) {
...
class ct extends ot {
  constructor(e, s, n) {
    ...
    return d(this, g, Object.assign(
      { shape: "line" },
      n
    )), d(this, ue, { x: 0, y: 0 }), d(this, fe, { x: this.graphConfig.width, y: this.graphConfig.height }), this.shape = b(this, Me, Ii).call(this), this.computed(), this;
  }
  get config() {
    return o(this, g);
  }
  set config(e) {
    d(this, g, e), b(this, Me, Ii).call(this);
  }
  get start() {
    return o(this, ue);
  }
...
class O extends ot {
  constructor(e, s, n) {
    ...
    return d(this, F, { x: NaN, y: NaN }), d(this, z, Object.assign(
      ...
      n
    )), this.computed(), this.shape = b(this, Ot, Ht).call(this), this;
  }
  get config() {
    return o(this, z);
  }
  set config(e) {
    d(this, z, e), b(this, Ot, Ht).call(this);
  }
  get size() {
    return o(this, z).size;
  }
  set size(e) {
    o(this, z).size = e, b(this, Ot, Ht).call(this);
  }
  get pixels() {
    return o(this, F);
  }
  ...
  asCircle(e) {
    return this.config.shape = "circle", this.config.size = e ?? 2, b(this, Ot, Ht).call(this), this;
  }
  asSquare(e) {
    return this.config.shape = "square", this.config.size = e ?? 10, b(this, Ot, Ht).call(this), this;
  }
  asCrosshair(e) {
    return this.config.shape = "crosshair", this.config.size = e ?? 10, b(this, Ot, Ht).call(this), this;
  }
  computed() {
    ...
    if (o(this, z).projection) {
      ...
      if (Mo(o(this, z).projection.axis)) {
...
class We extends ot {
  constructor(e, s, n) {
    ...
    p(this, ht);
    p(this, Dt);
    return d(this, ht, Object.assign({
      expression: "",
      samples: this.graphConfig.axis.x.x
    }, n)), this.shape = b(this, Ke, Ws).call(this), d(this, Dt, new Ye(o(this, ht).expression)), this.computed(), this;
  }
  get config() {
    return o(this, ht);
  }
  set config(e) {
    d(this, ht, e), d(this, Dt, new Ye(o(this, ht).expression)), this.computed();
  }
  computed() {
    const e = o(this, ht).expression;
    if (!e || e === "")
      return this;
    const s = -this.graphConfig.origin.x / this.graphConfig.axis.x.x - 1, n = (this.graphConfig.width - this.graphConfig.origin.x) / this.graphConfig.axis.x.x + 1, r = o(this, ht).domain ?? { min: s, max: n }, h = o(this, ht).image ?? { min: -1 / 0, max: 1 / 0 }, a = o(this, ht).samples ?? this.graphConfig.axis.x.x, c = o(this, Dt), l = [];
    for (let x = r.min; x < r.max; x += 1 / a) {
      const v = c.evaluate({ x });
      if (isNaN(v) || v === 1 / 0 || v === -1 / 0 || v < h.min || v > h.max) {
        const L = H({ x, y: 0 }, this.graphConfig);
        l.push({ x: L.x, y: NaN });
      } else
        l.push(H({ x, y: v }, this.graphConfig));
    }
    let u = l[0];
    const f = l.map(({ x, y: v }, L) => {
      let A = L === 0 ? "M" : "L";
      return isNaN(v) ? (A = "M", v = -123456789) : u.y === -123456789 && (A = "M"), u = { x, y: v }, `${A} ${x} ${v}`;
    }).join(" ");
  ...
  evaluate(e, s) {
    return s === !0 ? { x: e, y: o(this, Dt).evaluate({ x: e }) } : H(
      { x: e, y: o(this, Dt).evaluate({ x: e }) },
      this.graphConfig
    );
  }
  follow(e, s) {
...
ht = new WeakMap(), Dt = new WeakMap(), Ke = new WeakSet(), Ws = function() {
...
class zo extends ot {
  constructor(e, s, n) {
    ...
    d(this, bt, Object.assign({
      ...
      center: { x: 0, y: 0 },
      radius: 1
    }, n)), b(this, Se, Mi).call(this), this.computed();
  }
  get config() {
    return o(this, bt);
  }
  set config(e) {
    d(this, bt, e), b(this, Se, Mi).call(this);
  }
  get center() {
...
class Do extends ot {
  constructor(e, s, n) {
    ...
    d(this, I, Object.assign({
      shape: "polygon"
    }, n)), b(this, qt, Li).call(this), this.computed();
  }
  get config() {
    return o(this, I);
  }
  set config(e) {
    d(this, I, e), b(this, qt, Li).call(this);
  }
  get vertices() {
...
I = new WeakMap(), qt = new WeakSet(), Si = function() {
  ...
  var s;
  this.element.clear();
  const e = b(this, qt, Si).call(this);
...
class Po extends ot {
  constructor(e, s, n) {
    ...
    return this.static = !0, d(this, q, Object.assign(
      ...
      n
    )), this.shape = b(this, se, Ks).call(this), this.computed(), this;
  }
  get config() {
    return o(this, q);
  }
  ...
  computed() {
    const s = [
      ...b(this, se, Ei).call(this, o(this, q).axis.x, o(this, q).axis.y),
      ...b(this, se, Ei).call(this, o(this, q).axis.y, o(this, q).axis.x)
    ].reduce((r, h) => {
      const [a, c] = h;
...
class jo extends ot {
  ...
  set config(e) {
    d(this, K, e), b(this, Ze, Zs).call(this), this.computed();
  }
  get center() {
...
class Fo extends ot {
  constructor(e, s, n) {
    ...
    p(this, dt);
    p(this, Pt);
    return this.static = !0, Object.values(Ne).includes(n) ? d(this, dt, b(this, It, Qs).call(this, n)) : d(this, dt, n), d(this, Pt, b(this, It, Js).call(this)), this.computed(), this;
  }
  get config() {
    return o(this, dt);
  }
  ...
  computed() {
    return b(this, It, zi).call(this, o(this, Pt).x, o(this, dt).x.direction, o(this, dt).x), b(this, It, zi).call(this, o(this, Pt).y, o(this, dt).y.direction, o(this, dt).y), this;
  }
  moveLabel() {
    throw new Error("Method not implemented.");
  }
}
dt = new WeakMap(), Pt = new WeakMap(), It = new WeakSet(), Qs = function(e) {
  return Ne.POLAR, {
    x: {
...
class Ro extends ot {
  constructor(e, s, n) {
    ...
    }), this.shape = b(this, Qe, tn).call(this), this.computed(), this;
  }
  get config() {
    return o(this, wt);
  }
...
class $o extends ot {
  constructor(e, s, n) {
    ...
    return d(this, _t, Object.assign({
      size: 10
    }, n)), this.appearance.fill.color = "black", d(this, vt, o(this, _t).follow.follow(0, 0)), d(this, Qt, { x: 0, y: 0 }), d(this, pe, this.element.line()), d(this, jt, this.element.circle(o(this, _t).size).center(o(this, vt).x, o(this, vt).y)), this.shape = b(this, Je, en).call(this), this.computed(), this.rootSVG.on("mousemove", (r) => {
      var c;
      ...
      isNaN(a.y) ? o(this, jt).hide() : (o(this, jt).show(), o(this, jt).center(a.x, a.y), d(this, vt, a), d(this, Qt, o(this, _t).follow.follow(h.x + 0.01, h.y + 0.01)), this.computed());
    }), this;
  }
  get config() {
    return o(this, _t);
...
_t = new WeakMap(), vt = new WeakMap(), Qt = new WeakMap(), jt = new WeakMap(), pe = new WeakMap(), Je = new WeakSet(), en = function() {
...
class Bo extends ot {
  constructor(e, s, n) {
    ...
    return d(this, pt, Object.assign({
      samples: 100
    }, n)), this.shape = b(this, ti, sn).call(this), this.computed(), this;
  }
  get config() {
    return o(this, pt);
  }
...
class qo extends ot {
  constructor(e, s, n) {
    ...
    p(this, ei);
    p(this, V);
    d(this, V, Object.assign({}, n)), this.shape = b(this, ei, nn).call(this), this.computed();
  }
  get config() {
    return o(this, V);
  }
...
class Vo {
  constructor(t, e) {
    ...
    }), d(this, Z, {}), b(this, Ee, Di).call(this), this;
  }
  get rootSVG() {
    return o(this, G);
  }
  ...
  draggable(t, e) {
    const s = (n) => {
      ...
      let { x: a, y: c } = h;
      n.preventDefault(), !(a < 0 || a > o(this, N).width - h.width / 2) && (c < 0 || c > o(this, N).height - h.height / 2 || ((l = e == null ? void 0 : e.follow) != null && l.length && e.follow.forEach((u) => {
        let f = { x: a, y: c };
        u instanceof ot ? f = u.follow(a, c) : typeof u == "string" ? f = this.follow(u, r)(a, c) : f = u(a, c), a = f.x, c = f.y;
  ...
  updateLayout() {
    o(this, G).viewbox(0, 0, o(this, N).width, o(this, N).height), o(this, G).data("config", {
      ...
      origin: o(this, N).origin,
      axis: o(this, N).axis
    }), b(this, Ee, Di).call(this), this.update([], !0);
  }
...
G = new WeakMap(), U = new WeakMap(), Z = new WeakMap(), N = new WeakMap(), kt = new WeakMap(), me = new WeakMap(), Ee = new WeakSet(), Di = function() {
...
function he(i, t, e) {
  ...
  if (i.key === S.PERPENDICULAR && s.length === 2) {
    const [n, r] = s;
    if (n instanceof ct && r instanceof O)
  ...
  if (i.key === S.BISECTOR && s.length === 2) {
    const [n, r] = s;
    if (n instanceof ct && r instanceof ct)
...
function Zo(i, t, e) {
  ...
  if (i.key === S.PROJECTION && s.length === 2) {
    const n = s[0], r = s[1];
    if (n instanceof O && (r instanceof ct || r === "Ox" || r === "Oy"))
      return { projection: { point: n, axis: r } };
  }
  if (i.key === S.INTERSECTION && s.length === 2) {
    const n = s[0], r = s[1];
    if ((n instanceof ct || n === "Ox" || n === "Oy") && (r instanceof ct || r === "Ox" || r === "Oy"))
      return { intersection: { A: n, B: r } };
  }
  if (i.key === S.SYMMETRY && s.length === 2) {
    const n = s[0], r = s[1];
    if (n instanceof O && (r instanceof O || r instanceof ct || r === "Ox" || r === "Oy"))
      return { symmetry: { A: n, B: r } };
  }
  if (i.key === S.DIRECTION_POINT && s.length >= 3) {
    const [n, r, h, a] = s;
    if (n instanceof O && (r instanceof ct || r === "Ox" || r === "Oy") && typeof h == "number")
      return {
        direction: {
          direction: r,
          distance: h,
...
var Jt, Ft, D, rn, Pi, on, hn, an, cn, ln, un, fn, dn, qe;
class sh extends Vo {
  constructor(e, s) {
    super(e, {
    ...
    p(this, Jt);
    p(this, Ft);
    return d(this, Ft, {}), s != null && s.parameters && this.refreshLayout(s.parameters), d(this, Jt, []), s != null && s.code && b(this, D, Pi).call(this, s.code), this;
  }
  ...
  refresh(e) {
    this.clear(), b(this, D, Pi).call(this, e);
  }
  refreshLayout(e) {
    const s = b(this, D, an).call(this, e);
...
`).map((h) => h.trim()).filter((h) => h.trim() !== "" && !h.startsWith("$")), r = {};
  for (const h of n) {
    if (h.startsWith("@")) {
      const { key: c, value: l } = b(this, D, hn).call(this, h);
      r[c] = { value: l, options: [] };
      continue;
    }
    const a = b(this, D, cn).call(this, h);
 ...
 */
Pi = function(e) {
  d(this, Jt, b(this, D, rn).call(this, e));
  const s = ps;
  o(this, Jt).forEach((n) => {
    let r = n.id, h = 1;
    ...
    if (s[n.key]) {
      ...
      if (f && f.length > 0 && Object.keys(n.parameters).length === 0 && Object.keys(n.parameters).filter((x) => f.includes(x)).forEach((x) => {
        n.parameters[x] = { value: !0, options: [] };
      }), Object.hasOwn(c, u))
        try {
    ...
    a && (o(this, Ft).label && a instanceof O && n.parameters.label === void 0 && n.parameters.tex === void 0 && (n.parameters.label = { value: !0, options: [] }), o(this, Ft).tex && a instanceof O && n.parameters.label === void 0 && n.parameters.tex === void 0 && (n.parameters.tex = { value: !0, options: [] }), a instanceof O && o(this, Ft).points === !1 && (n.parameters["!"] = { value: !0, options: [] }), b(this, D, on).call(this, n.parameters, a));
  });
}, on = function(e, s) {
  Object.keys(e).forEach((n) => {
    ...
    switch (n) {
      ...
      case "drag":
        if (s instanceof O) {
          const h = { follow: [] };
          [e[n].value, ...e[n].options].forEach((a) => {
            var c, l, u;
            if (["grid", "Ox", "Oy"].includes(a) && ((c = h.follow) == null || c.push(this.follow(a, s))), Rt(a)) {
              const f = a.axis ?? "x", m = this.toPixels(a, f);
              (l = h.follow) == null || l.push(
                (x, v) => ({
                  x: f === "x" ? Math.max(m.min, Math.min(x, m.max)) : x,
                  y: f === "y" ? Math.max(m.min, Math.min(v, m.max)) : v
                })
              );
            }
            if (Object.hasOwn(this.figures, a)) {
              const f = this.figures[a];
              (u = h.follow) == null || u.push((m, x) => f.follow(m, x));
            }
          }), this.layers.interactive.add(s.element), s.asCircle(20).fill("white/0.8"), this.draggable(s, h);
        }
        break;
    }
  });
  ...
  const s = b(this, D, qe).call(this, e), n = s.ppu ? parseFloat(s.ppu.value) : 50, r = s.x && Rt(s.x.value) ? s.x.value : { min: -8, max: 8 }, h = s.y && Rt(s.y.value) ? s.y.value : { min: -8, max: 8 }, a = Math.abs(r.max - r.min), c = Math.abs(h.max - h.min), l = a * n, u = c * n, f = {
    x: -r.min * n,
    y: h.max * n
  }, m = Ne.CARTESIAN_2D, x = {
    x: { x: n, y: 0 },
    y: { x: 0, y: -n }
  }, v = !!s.grid, L = !!s.axis, A = s.subgrid ? parseFloat(s.subgrid.value) : 0, $ = {
    label: !!s.label,
    tex: !!s.tex,
  ...
  const [s, n] = e.split("->"), r = b(this, D, ln).call(this, s);
  return r.parameters = Object.assign(
    r.parameters,
    b(this, D, qe).call(this, n)
  ), r;
}, ln = function(e) {
  if (e.match(/^[A-Z][0-9]*\(.*\)$/))
    return b(this, D, un).call(this, e);
  if (e.match(/^[a-z][0-9]*\([x|t]\)/))
    return b(this, D, dn).call(this, e);
  if (e.includes("=") && !e.includes(" "))
    return b(this, D, fn).call(this, e);
  ...
  const s = e.split("(")[0], n = e.split("(")[1].split(")")[0].split(","), r = b(this, D, qe).call(this, e.split(")")[1]);
  return {
    id: s,
    key: S.POINT,
    code: n,
